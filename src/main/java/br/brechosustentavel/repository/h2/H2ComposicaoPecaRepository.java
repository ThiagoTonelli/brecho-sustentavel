 ...
 * @author thiag
 */
public class H2ComposicaoPecaRepository implements IComposicaoPecaRepository {
    private ConexaoFactory conexaoFactory;
    
    public H2ComposicaoPecaRepository(ConexaoFactory conexaoFactory) {
    ...
    public void adicionarComposicaoAPeca(Peca peca, IComposicaoRepository composicaoRepository) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao inserir a composição para a peça " + idPeca + " no H2", e);
        }
    }
    ...
    public void excluirComposicaoDaPeca(String idPeca) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao excluir a composição da peça com ID " + idPeca + " no H2", e);
        }
    }
    ...
    public Map<String, Integer> buscarComposicaoPorPeca(String idPeca) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar a composição da peça com ID " + idPeca + " no H2", e);
        }
    ...
    public Map<String, Double> getMassaTotalPorMaterial() {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar massa total por material no H2: " + e.getMessage(), e);
        }
