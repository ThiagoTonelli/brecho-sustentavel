 ...
 * @author thiag
 */
public class H2VendedorRepository implements IVendedorRepository {
    private final ConexaoFactory conexaoFactory;

    public H2VendedorRepository(ConexaoFactory conexaoFactory) {
    ...
    public void salvar(Vendedor vendedor) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao cadastrar vendedor: " + e.getMessage(), e);
        }
    }
    ...
    public void atualizarEstrelas(int id, double qtdEstrelas) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao atualizar estrelas do vendedor: " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Double> getTopVendedoresPorGWP(int limite) {
        ...
        String sql = """
                     SELECT u.nome, v.gwp_contribuido
                     FROM vendedor v
                     INNER JOIN usuario u ON v.id_vendedor = u.id
                     ORDER BY v.gwp_contribuido DESC
                     LIMIT ?;
                     """;
    ...
    public void atualizarVendas(int id) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao atualizar quantidade de vendas do vendedor: " + e.getMessage(), e);
        }
    }
