 ...
 * @author thiag
 */
public class H2DefeitoRepository implements IDefeitoRepository {
    private final ConexaoFactory conexaoFactory;
    private final ITipoDePecaRepository tipoPecaRepository;

    public H2DefeitoRepository(ConexaoFactory conexaoFactory, ITipoDePecaRepository tipoPecaRepository) {
    ...
    public Map<String, Double> buscarDefeitosPorTipo(String tipoPeca) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar defeitos por tipo de peça no H2: " + e.getMessage(), e);
        }
    }
    ...
    public Integer buscarIdPeloNomeDoDefeito(String nomeDefeito){
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar id do defeito no H2: " + e.getMessage(), e);
        }
        return null; 
    }
    ...
    public List<Map<String, Object>> buscarTodosParaManutencao() {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar todos os defeitos no H2: " + e.getMessage(), e);
        }
        return defeitos;
    }
    ...
    public void salvar(Integer id, String nome, double desconto, int idTipoPeca) {
        if (id == null) {
            ...
            try (Connection conexao = this.conexaoFactory.getConexao();
                ...
                throw new RuntimeException("Erro ao inserir novo defeito no H2: " + e.getMessage(), e);
            }
        } else {
            ...
            try (Connection conexao = this.conexaoFactory.getConexao();
                ...
                throw new RuntimeException("Erro ao atualizar defeito com ID " + id + " no H2: " + e.getMessage(), e);
            }
        }
    }
    ...
    public void excluir(int idDefeito) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao excluir defeito com ID " + idDefeito + " no H2. Verifique se ele não está em uso.", e);
        }
    }
}
