...
public class SQLiteComposicaoRepository implements IComposicaoRepository{
    ...
    public List<Map<String, Object>> buscarTodosParaManutencao() {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao buscar todas as composições: " + e.getMessage(), e);
        }
        return composicoes;
    }
    ...
    public void salvar(Integer id, String nome, double fatorEmissao) {
        if (id == null) {
            ...
            try (Connection conexao = this.conexaoFactory.getConexao();
                ...
                throw new RuntimeException("Erro ao inserir nova composição: " + e.getMessage(), e);
            }
        } else {
            ...
            try (Connection conexao = this.conexaoFactory.getConexao();
                ...
                throw new RuntimeException("Erro ao atualizar composição: " + e.getMessage(), e);
            }
        }
    }
    ...
    public void excluir(int idComposicao) {
        ...
        try (Connection conexao = this.conexaoFactory.getConexao();
            ...
            throw new RuntimeException("Erro ao excluir composição. Verifique se ela não está em uso por alguma peça.", e);
        }
    }
}
